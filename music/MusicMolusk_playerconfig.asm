...
; It indicates what parts of code are useful to the song, to save both memory and CPU.
; The player may or may not take advantage of these flags, it is up to it.
